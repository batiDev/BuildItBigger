 ...
 * on 2015-09-22 at 11:10:52 UTC 
 * Modify at your own risk.
 */

package com.example.levani.builditbigger.jokecloud.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://jokecloud-1070.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.levani.builditbigger.jokecloud.myApi.model.Joke> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.levani.builditbigger.jokecloud.myApi.model.Joke.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.levani.builditbigger.jokecloud.myApi.model.Joke> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.levani.builditbigger.jokecloud.myApi.model.Joke.class);
